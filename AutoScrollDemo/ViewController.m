...
- (void)createControlByLocalImage
{
    ...
    HWAutoScrollView *view = [[HWAutoScrollView alloc] initWithImageNameArray:imageNameArray imageOnClickCallBack:^(NSInteger imageIndex){
        NSLog(@"-->> LocalImageIndex:%ld", (long)imageIndex);
    }];
